...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableView.setGeometry(QtCore.QRect(10, 10, 341, 631))
        ...
        self.DrawButton.setGeometry(QtCore.QRect(360, 70, 61, 23))
        self.DrawButton.setObjectName("DrawButton")
        self.tableView_2 = QtWidgets.QTableView(self.centralwidget)
        self.tableView_2.setGeometry(QtCore.QRect(430, 441, 791, 201))
        self.tableView_2.setObjectName("tableView_2")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(570, 70, 241, 111))
        self.groupBox.setObjectName("groupBox")
        self.radioButton = QtWidgets.QRadioButton(self.groupBox)
        self.radioButton.setGeometry(QtCore.QRect(0, 30, 174, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.DrawButton.setText(_translate("MainWindow", "统计"))
